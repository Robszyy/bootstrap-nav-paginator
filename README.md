...
![Demo](https://github.com/Robszyy/Bootstrap-Nav-Paginator/blob/main/examples/ressources/demo.gif)

# Dependencies
 - Bootstrap 3.3 or higher

# Installation
You can download the plug-in [here](https://github.com/Robszyy/Bootstrap-Nav-Paginator/releases), or include the file from the [CDN](https://github.com/Robszyy/Bootstrap-Nav-Paginator/releases).
...
# Examples
You can check for examples [here](https://github.com/Robszyy/Bootstrap-Nav-Paginator/tree/main/examples).
